            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed top-14 right-6 z-[9999] w-80 bg-[#0d1424]/95 backdrop-blur-xl border border-[#1e3a5f]/50 rounded-2xl shadow-2xl overflow-hidden"
                    >
                        {/* Header */}
                        <div className="p-6 border-b border-[#1e3a5f]/30 bg-gradient-to-br from-blue-500/10 to-purple-500/10">
                        ...
                        <div className="p-2">
                            ...
                            <ProfileMenuItem 
                                icon={<Bell size={16} />} 
                                label="Notifications" 
                                description="Manage intel alerts"
                                badge="2"
                            />
                            <ProfileMenuItem 
                                icon={<Shield size={16} />} 
                        ...
                        {/* Footer */}
                        <div className="p-4 bg-black/20 border-t border-[#1e3a5f]/20">
