...
function EntityNode({ id, data, selected }: any) {
    ...
    return (
        <BaseNode id={id} className={cn(selected && "scale-105 transition-transform")}>
            <div className="flex flex-col items-center gap-2.5">
                ...
                <div className="text-center w-max min-w-[120px]">
                    <div className="text-[12px] font-bold leading-tight text-center uppercase tracking-wide font-sans drop-shadow-md text-white/90">
                        {data.name}
                    </div>
                    {data.role && (
